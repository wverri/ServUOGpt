...
namespace Server.Items
{
    ...
    public class ScrollOfTranscendenceBook : BaseSpecialScrollBook
    {
        ...
        public static void Initialize()
        {
            ...
            _SkillInfo[SkillCat.TradeSkills] = new List<SkillName>() { SkillName.Alchemy, SkillName.Blacksmith, SkillName.Bowcraft, SkillName.Carpentry, SkillName.Cooking, SkillName.Inscribe, SkillName.Lumberjacking, SkillName.Mining, SkillName.Tailoring, SkillName.Tinkering };
