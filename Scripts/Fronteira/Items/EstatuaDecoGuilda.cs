...
{
    public class DecorativeGuildstone : Item, ISecurable, IDyable
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            if (Guild == null)
            {
                from.SendLocalizedMessage("Tranque este item em casa e clique 1x com o esquerdo para atualiza-lo"); // The guild this stone is linked to is no longer valid.
            }
        ...
        public class GuildInformationGump : Gump
        {
                ...
                : base(100, 100)
            {
                ...
                AddHtml(10, 10, 500, 18, $"<DIV ALIGN=CENTER>{g.Name }</DIV>", 0x7FFF, false, false); // <DIV ALIGN=CENTER>~1_TOKEN~</DIV>
                AddHtml(10, 30, 500, 18, $"<DIV ALIGN=CENTER>{g.Abbreviation }</DIV>", 0x7FFF, false, false); // <DIV ALIGN=CENTER>~1_TOKEN~</DIV>
                ...
                AddHtml(10, 150, 500, 18, $"<DIV ALIGN=CENTER>{ (g.Leader != null ? g.Leader.Name : "Desconhecido") }</DIV>", 0x1745, false, false); // <DIV ALIGN=CENTER>~1_TOKEN~</DIV>
