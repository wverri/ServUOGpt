...
namespace Server.Dueling
{
	public class DuelPlayerInfoGump : Gump
	{
			...
			: base( 200, 00 )
		{
            ...
            this.AddLabel( 105, 43, 36, @"Duelos Dragonic" );
            this.AddLabel( 105, 42, 36, @"Duelos Dragonic");
            this.AddLabel( 168, 91, 36, @"Vitorias:" );
            this.AddLabel( 168, 90, 36, @"Vitorias:");
            this.AddLabel( 122, 69, 36, @"Jogador: " + duelPoints.Mobile.Name );
            this.AddLabel( 122, 68, 36, @"Jogador: " + duelPoints.Mobile.Name );
            this.AddLabel( 163, 189, 36, @"Derrotas:" );
            this.AddLabel( 163, 188, 36, @"Derrotas:");
            this.AddLabel( 81, 289, 36, @"Duelo mais rapido:" );
            this.AddLabel( 81, 288, 36, @"Duelo mais rapido:");
            this.AddLabel( 87, 383, 36, @"Duelo mais longo:" );
            this.AddLabel( 87, 382, 36, @"Duelo mais longo:");
